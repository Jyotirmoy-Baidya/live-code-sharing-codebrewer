...
function CodingPlaygroundForParticipants({ code, setCode, language, input, setInput, output, metrics, getLanguageExtension, customInput, setCustomInput, testCasesResult, editorBoxData, setEditorBoxData, editorData, setEditorData }) {
...
export default CodingPlaygroundForParticipants;